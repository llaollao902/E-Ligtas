...
public abstract class BaseFrameWithSidebar extends JFrame {
    ...
    /**
     * Handle logout action - returns to home screen.
    ...
    protected void onLogoutClick() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                new controller.HomeController(homeScreen, userManager);
                homeScreen.setVisible(true);
                dispose();
            } catch (Exception e) {
                showError("Logout Error", "Unable to return to home screen: " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
